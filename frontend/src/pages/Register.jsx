    ...
    <div className="min-h-[75vh] flex items-center justify-center px-4 py-8 relative">
      ...
      >
        <div className="text-center space-y-2 mb-8">
          ...
          <p className="text-xs text-[#6B7280] font-medium">Create an account to unlock AI aggregations</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <FiUser className="absolute left-4 top-3.5 text-[#C89B63]" size={16} />
              <input
                type="text"
        ...
        <div className="mt-6 text-center text-xs text-[#6B7280] font-medium">
          ...
          <Link to="/login" className="font-extrabold text-[#C89B63] hover:underline">
            {t('login')}
          </Link>
        </div>
      </motion.div>
